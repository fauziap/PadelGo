    ...
    <style>
        ...
        .register-left {
            background:
                ...
                url('https://plus.unsplash.com/premium_photo-1708692919998-e3dc853ef8a8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
        ...
        <div class="row register-container">
            ...
            <div class="col-lg-6 register-left d-none d-lg-flex">
                <div class="register-left-content">
                    <h2>Booking Lapangan Padel Jadi Lebih Mudah</h2>
                    <p>
                        Masuk ke akun Anda untuk memilih jadwal, memesan lapangan padel,
                        dan menyelesaikan pembayaran dengan cepat.
                    </p>

                    <ul class="feature-list">
                        <li>Booking lapangan padel tanpa antre</li>
                        <li>Pilih tanggal dan jam bermain secara real-time</li>
                        <li>Lihat riwayat booking dan status pembayaran</li>
                        <li>Kelola jadwal main padel lebih praktis</li>
                    </ul>
                </div>
                ...
                <div class="padel-preview-card">
                    <img src="https://plus.unsplash.com/premium_photo-1708692919998-e3dc853ef8a8?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        alt="Lapangan padel modern dengan suasana olahraga">

                    <div class="padel-preview-caption">
                        <i class="fas fa-table-tennis-paddle-ball me-2"></i>
                        Temukan jadwal terbaik dan nikmati pengalaman bermain padel yang lebih nyaman.
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-6 register-right">
                ...
                <p class="form-subtitle">
                    Masuk ke akun Anda untuk booking lapangan padel favorit.
                </p>
                ...
                <div class="login-link">
                    Belum punya akun? <a href="/sign-up">Daftar di sini</a>
                </div>
            </div>
        </div>
    </div>
